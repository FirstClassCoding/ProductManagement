    ...
    headerTable += `
        <tr>
            <td class = 'name-column'>
                <input class = 'enter-data readonly' type = 'text' name = 'name' id = 'edit-name' required readonly>
            </td>
            <td class = 'description-column'>
                <input class = 'enter-data readonly' type = 'text' name = 'description' id = 'edit-description' required readonly>
            </td>
            <td class = 'amount-column'>
                <input class = 'enter-data' type = 'text' name = 'amount' id = 'edit-amount' required>
            </td>
            <td class = 'price-column'>
                <input class = 'enter-data readonly' type = 'text' name = 'price' id = 'edit-price' required readonly>
            </td>
...
document.getElementById('list-data').addEventListener('submit', (event) => {
    ...
    axios({
        method: "put",
        url: "http://127.0.0.1:3000/data/sellgoods",
        data: {
            listData
          }
        })
    ...
    window.location.replace("/sellgoods");
});