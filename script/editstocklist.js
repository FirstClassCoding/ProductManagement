    ...
    headerTable += `
        <tr>
            ...
            <td class = 'description-column'>
                <input class = 'enter-data' type = 'text' name = 'description' id = 'edit-description' required>
            </td>
            <td class = 'amount-column'>
                <input class = 'enter-data readonly' type = 'text' name = 'amount' id = 'edit-amount' required readonly>
            </td>
            <td class = 'price-column'>
                <input class = 'enter-data' type = 'text' name = 'price' id = 'edit-price' required>
            </td>
...
document.getElementById('list-data').addEventListener('submit', (event) => {
    ...
    window.location.replace("/editstocklist");
});